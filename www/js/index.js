...
var app = {
    consumerKey : 'carlosrojas-o',
    consumerSecret : '19ac59ab28be1572',
 ...
 success: function(data) {
     ...
     if(isCallBackConfirmed) {
         ...
         var note = new Note;
         note.content = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><!DOCTYPE en-note SYSTEM \"http://xml.evernote.com/pub/enml2.dtd\"><en-note><span style=\"font-weight:bold;\">Nota.</span><br /></en-note>";
         note.title = "Hello, blablabla" + date();
